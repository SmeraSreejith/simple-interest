...
function App() {
  //state to whole values from input field
  ...
  return (
    <>
   <div className='d-flex justify-content-center align-item-center p-5 ' style={{width:'100%',height:'100vh'}}>

    <div className='bg-light p-5 rounded' style={{width:'500px'}}>
     <h1>Simple Interest App</h1>
     <p>Calculate your simple Interest Easily</p>
     <div className='mt-3 flex-column rounded shadow bg-warning d-flex justify-content-center align-items-center p-4'>
